...
const ItineraryCard = ({ itinerary }) => {
  return (
    <div className="relative block overflow-hidden rounded-lg border bg-sky-200 border-gray-100 p-4 sm:p-6 lg:p-8">
    ...
    <p className="text-sm font-medium text-gray-600">Likes: {itinerary.likes || 0}</p>
      ...
      <button className="mt-4 bg-blue-400 hover:bg-blue-650 text-white font-bold py-2 px-4 rounded">
